...
namespace app
{
...

    {
        ...
        m_ao_test_steps = {
            ...
            {5*1000, std::chrono::milliseconds(500), 2500},
            {5*1000, std::chrono::milliseconds(500), 500},
            {7*1000, std::chrono::milliseconds(400), 800},
            ...
            {3*1000, std::chrono::milliseconds(600), 1500},
            {3*1000, std::chrono::milliseconds(300), 500},
            ...
            {200*1000, std::chrono::milliseconds(300), 500},
            {250*1000, std::chrono::milliseconds(300), 600},
            {3*1000, std::chrono::milliseconds(700), 300},
