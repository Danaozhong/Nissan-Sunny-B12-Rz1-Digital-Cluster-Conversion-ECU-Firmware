...
namespace drivers
{
	...
	public:
		...
		/* voltages measured in mV */
		virtual int32_t set_output_voltage(int32_t i32_value) = 0;
		virtual int32_t get_max_voltage() const = 0;
		virtual int32_t get_min_voltage() const = 0;
	};
}
